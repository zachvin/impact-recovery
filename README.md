...
Setup takes about 3 minutes. It is tested using Python 3.10 on Ubuntu 22.04 using `virtualenv`. I haven't been able to get the PyBullet environment to show GUI properly on WSL.
